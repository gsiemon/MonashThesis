...
<!-- We use the Latex \section*{} here rather than RMarkdown ## to ensure that each heading doesn't appear in the Table of Contents -->
...
``` {r, abbrviations-symbols, child = "00-symbols.Rmd"}
```
<!-- \input{./PreliminaryAndBackPages/Symbols.tex}  -->
