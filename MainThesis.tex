...
\currentdegrees{B.E (Chem) Hons., B.Sc., Grad. Cert. Bus. Admin.}

%***ORCID ID***
%Add and hyperlink your ORCID
\orcid{\href{https://orcid.org/}{0000-0001-6051-4271}}
...
%RMarkdown files are inserted here
$body$
...
%Code here replaced with Biblatex code (Ref: Rob Hyndman) in uqthesis.cls
%\bibliographystyle{apalike}
%\bibliographystyle{elsarticle-num}

%\bibliography{./References/Bibliography}
\printbibliography[heading=bibintoc]  %Ref: Rob Hyndman
